...
describe('SidebarComponent', () => {
	...
	it('#isValidRSSFeed() should return true for valid RSS Feeds', () => {
		const validXML = '<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>test</title><link>test</link><description>test</description><item><title>test</title><link>test</link><description>test</description></item></channel></rss>';
	...
	it('#isValidRSSFeed() should return false for invalid RSS Feeds', () => {
		const invalidXML = '<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>test</title><link>test</link><description>test</description><item></item></channel></rss>';
